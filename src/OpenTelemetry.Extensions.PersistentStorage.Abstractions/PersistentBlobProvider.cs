...
namespace OpenTelemetry.Extensions.PersistentStorage.Abstractions
{
    ...
    public abstract class PersistentBlobProvider
    {
        ...
        public bool TryCreateBlob(byte[] buffer, int leasePeriodMilliseconds, [NotNullWhen(true)] out PersistentBlob? blob)
        {
            ...
            {
                PersistentStorageAbstractionsEventSource.Log.PersistentBlobProviderException("Failed to create and lease the blob", ex);
                blob = null;
                return false;
            }
        }
        ...
        public bool TryCreateBlob(byte[] buffer, [NotNullWhen(true)] out PersistentBlob? blob)
        {
            ...
            {
                PersistentStorageAbstractionsEventSource.Log.PersistentBlobProviderException("Failed to create the blob", ex);
                blob = null;
                return false;
            }
        }
        ...
        public bool TryGetBlob([NotNullWhen(true)] out PersistentBlob? blob)
        {
            ...
            {
                PersistentStorageAbstractionsEventSource.Log.PersistentBlobProviderException("Failed to get a single blob", ex);
                blob = null;
                return false;
            }
        }
        ...
        public IEnumerable<PersistentBlob> GetBlobs()
        {
            ...
            {
                PersistentStorageAbstractionsEventSource.Log.PersistentBlobProviderException("Failed to get all the blobs", ex);

...
[metrics](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/db/elasticsearch.md#metrics)
and
[traces](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/db/elasticsearch.md#spans).

...
* Added a timeout of `2 seconds` for `HttpClient` for outgoing call made to
  metadata service. This is to improve the start up time of applications running
  not running on Azure VMs.

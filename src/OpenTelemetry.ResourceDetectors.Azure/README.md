...
| cloud.platform           | The cloud platform, which is always set to "azure" in this context.                                                                                                                                                                 |
| cloud.provider           | The cloud service provider, which is always set to "azure_vm" in this context.                                                                                                                                                      |

...
* Add support for metrics to exported to more than a single account/namespace
  combination.
  ([#1062](https://github.com/open-telemetry/opentelemetry-dotnet-contrib/pull/1062))

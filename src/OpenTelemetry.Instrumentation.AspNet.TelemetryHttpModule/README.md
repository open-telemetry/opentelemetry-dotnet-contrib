...
with the name `OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule`.
By default, .NET `ActivitySource` will not generate any `Activity` objects
unless there is a registered listener.

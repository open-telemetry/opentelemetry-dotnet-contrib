...
public static class GenAiAttributes
{
    ...
    /// </summary>
    /// <remarks>
    /// Instrumentations MUST follow <a href="https://github.com/open-telemetry/semantic-conventions/blob/v1.41.0/docs/gen-ai/gen-ai-input-messages.json">Input messages JSON schema</a>.
    ...
    /// </summary>
    [Obsolete("Replaced by <c>gen_ai.output.type</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]
    ...
    /// </summary>
    [Obsolete("Replaced by <c>gen_ai.request.seed</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]
    ...
    /// </summary>
    [Obsolete("Replaced by <c>openai.request.service_tier</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]
    ...
    /// </summary>
    [Obsolete("Replaced by <c>openai.response.service_tier</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]
    ...
    /// </summary>
    [Obsolete("Replaced by <c>openai.response.system_fingerprint</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]
    ...
    /// </summary>
    /// <remarks>
    /// Instrumentations MUST follow <a href="https://github.com/open-telemetry/semantic-conventions/blob/v1.41.0/docs/gen-ai/gen-ai-output-messages.json">Output messages JSON schema</a>
    /// <p>
    ...
    /// </summary>
    /// <remarks>
    /// Instrumentations MUST follow <a href="https://github.com/open-telemetry/semantic-conventions/blob/v1.41.0/docs/gen-ai/gen-ai-retrieval-documents.json">Retrieval documents JSON schema</a>.
    /// When the attribute is recorded on events, it MUST be recorded in structured
    /// form. When recorded on spans, it MAY be recorded as a JSON string if structured
    /// format is not supported and SHOULD be recorded in structured form otherwise.
    /// <p>
    ...
    /// </summary>
    [Obsolete("Replaced by <c>gen_ai.provider.name</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]
    ...
    /// <p>
    /// Instrumentations MUST follow <a href="https://github.com/open-telemetry/semantic-conventions/blob/v1.41.0/docs/gen-ai/gen-ai-system-instructions.json">System instructions JSON schema</a>.
    /// <p>
    ...
    /// </summary>
    /// <remarks>
    /// Instrumentations MUST follow <a href="https://github.com/open-telemetry/semantic-conventions/blob/v1.41.0/docs/gen-ai/gen-ai-tool-definitions.json">Tool Definitions JSON Schema</a>.
    /// <p>
    /// When the attribute is recorded on events, it MUST be recorded in structured
    /// form. When recorded on spans, it MAY be recorded as a JSON string if structured
    /// format is not supported and SHOULD be recorded in structured form otherwise.
    ...
    /// </summary>
    [Obsolete("Replaced by <c>gen_ai.usage.output_tokens</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]
    ...
    /// </summary>
    [Obsolete("Replaced by <c>gen_ai.usage.input_tokens</c>, which has moved to the OpenTelemetry GenAI semantic conventions repository (https://github.com/open-telemetry/semantic-conventions-genai).")]

// <copyright file="ElasticOptionsExtensions.cs" company="OpenTelemetry Authors">
...
{
    internal static class ElasticOptionsExtensions
    {
        internal static IJsonSerializable CreateMetadata(

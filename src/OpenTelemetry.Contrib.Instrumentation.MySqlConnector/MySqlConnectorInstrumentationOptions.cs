// <copyright file="MySqlConnectorInstrumentationOptions.cs" company="OpenTelemetry Authors">
...
{
    /// <summary>
    /// Options for <see cref="MySqlConnectorInstrumentation"/>.
    /// </summary>
    public class MySqlConnectorInstrumentationOptions
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether or not the <see cref="MySqlConnectorInstrumentation"/> should add the text as the <see cref="SemanticConventions.AttributeDbStatement"/> tag. Default value: False.
        /// </summary>
        public bool SetDbStatement { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether or not the <see cref="MySqlConnectorInstrumentation"/> should parse the DataSource on a SqlConnection into server name, instance name, and/or port connection-level attribute tags. Default value: False.
        /// </summary>
        /// <remarks>

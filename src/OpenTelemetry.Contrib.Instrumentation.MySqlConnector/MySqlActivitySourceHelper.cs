...
{
    /// <summary>
    /// Helper class to hold common properties used by MySqlConnectorDiagnosticListener.
    /// </summary>
    internal class MySqlActivitySourceHelper
    {
        public const string MySqlConnectorBaseSystemName = "mysql";
        ...
        {
            new KeyValuePair<string, object?>(SemanticConventions.AttributeDbSystem, MySqlConnectorBaseSystemName),
        };

        private static readonly Version Version = typeof(MySqlActivitySourceHelper).Assembly.GetName().Version ?? new Version(1, 0);

...
public static class AWSLambdaWrapper
{
    ...
    private static readonly ActivitySource AWSLambdaActivitySource = new(ActivitySourceName, ActivitySourceVersionHelper.GetVersion<AWSLambdaInstrumentationOptions>());

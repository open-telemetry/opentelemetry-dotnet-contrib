// <copyright file="StackdriverTraceActivityExporter.cs" company="OpenTelemetry Authors">
...
{
    public class StackdriverTraceActivityExporter : ActivityExporter {
        ...
        public StackdriverTraceActivityExporter(string projectId) {

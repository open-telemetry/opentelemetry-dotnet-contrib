...
{
    /// <summary>
    /// Extension methods to simplify registering of Stackdriver exporter.
    /// </summary>
    public static class TracerProviderBuilderExtensions
    {
        ...
        public static TracerProviderBuilder UseStackdriverExporter(this TracerProviderBuilder builder, string projectId, Action<ActivityProcessorPipelineBuilder> processorConfigure = null)
        {
            if (builder == null)
            {
            ...
            {
                var exporter = new StackdriverTraceExporter(projectId);

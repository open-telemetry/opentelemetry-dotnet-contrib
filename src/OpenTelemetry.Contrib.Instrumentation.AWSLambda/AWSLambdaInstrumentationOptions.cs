...
{
    /// <summary>
    /// Options for AWS lambda instrumentation.
    /// </summary>
    public class AWSLambdaInstrumentationOptions
    {
        /// <summary>
        /// Gets or sets a value indicating whether AWS X-Ray propagation is ignored.
        /// This option has to be used as a workaround until resolution of the issue
        /// https://github.com/open-telemetry/opentelemetry-dotnet/issues/3290.
        /// </summary>

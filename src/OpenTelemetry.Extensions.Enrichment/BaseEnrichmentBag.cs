// <copyright file="BaseEnrichmentBag.cs" company="OpenTelemetry Authors">
...
public abstract class BaseEnrichmentBag
{
    ...
    {
        this.bag.Add(new KeyValuePair<string, object>(key, value));
    }

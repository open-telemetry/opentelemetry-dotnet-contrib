...
internal static class OwinInstrumentationActivitySource
{
    ...
    internal static readonly ActivitySource ActivitySource = Trace.ActivitySourceFactory.Create(
        typeof(OwinInstrumentationActivitySource),
        SemanticConventionsVersion,
        name: "OpenTelemetry.Instrumentation.Owin.IncomingRequest");

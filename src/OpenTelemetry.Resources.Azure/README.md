...
| Attribute                 | Description                                                                                                                                                                                                                         |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| azure.resource_group.name | The Azure resource group the VM belongs to.                                                                                                                                                                                         |
...
| host.image.id             | The Azure resource ID of the VM image, where available.                                                                                                                                                                             |
| host.image.name           | The VM image in the form "{publisher}:{offer}:{sku}", for example "Canonical:UbuntuServer:18.04-LTS", where available.                                                                                                              |
| host.image.version        | The version of the VM image, for example "15.05.22", where available.                                                                                                                                                               |

...
| host.image.id          | The Azure resource ID of the VM image, from `storageProfile.imageReference.id`. Emitted when the value is non-empty.                                                                                                                |
| host.image.name        | The VM image in the form "{publisher}:{offer}:{sku}", for example "Canonical:UbuntuServer:18.04-LTS". Emitted when all three parts are non-empty.                                                                                   |
| host.image.version     | The version of the VM image, for example "15.05.22". Emitted when the value is non-empty.                                                                                                                                           |

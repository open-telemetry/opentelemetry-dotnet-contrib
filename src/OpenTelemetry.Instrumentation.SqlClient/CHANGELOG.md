...
* Added `OTEL_DOTNET_EXPERIMENTAL_SQLCLIENT_ENABLE_TRACE_CONTEXT_PROPAGATION`
  ...
  This will remain experimental while the [specification](https://github.com/open-telemetry/semantic-conventions/blob/v1.36.0/docs/database/sql-server.md#context-propagation)

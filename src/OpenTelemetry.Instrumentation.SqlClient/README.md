...
[v1.43](https://github.com/open-telemetry/semantic-conventions/blob/v1.43.0/docs/db/README.md)
...
[`db.response.returned_rows`](https://github.com/open-telemetry/semantic-conventions/blob/v1.43.0/docs/db/database-spans.md)
...
* [Semantic conventions for database client spans][semconv-spans]
* [Semantic conventions for database client metrics][semconv-metrics]
* [Semantic conventions for Microsoft SQL Server client operations](https://github.com/open-telemetry/semantic-conventions/blob/v1.43.0/docs/db/sql-server.md)

[semconv-metrics]: https://github.com/open-telemetry/semantic-conventions/blob/v1.43.0/docs/db/database-metrics.md
[semconv-spans]: https://github.com/open-telemetry/semantic-conventions/blob/v1.43.0/docs/db/database-spans.md

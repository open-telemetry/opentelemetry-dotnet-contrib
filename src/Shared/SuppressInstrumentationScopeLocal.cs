// <copyright file="SuppressInstrumentationScopeLocal.cs" company="OpenTelemetry Authors">
...
{
    internal sealed class SuppressInstrumentationScopeLocal : IDisposable
    {
        ...
        internal SuppressInstrumentationScopeLocal(bool value = true)
        {
        ...
        ///     {
        ///         using (SuppressInstrumentationScopeLocal.Begin())
        ///         {
        ...
        {
            return new SuppressInstrumentationScopeLocal(value);
        }

...
The script installs the pinned version of [Pester](https://pester.dev/), runs
every `*.Tests.ps1` file in this directory with code coverage enabled, and
fails if any test fails or if code coverage drops below the required minimum.

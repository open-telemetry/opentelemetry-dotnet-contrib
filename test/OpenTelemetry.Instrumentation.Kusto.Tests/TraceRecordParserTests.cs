...
public class TraceRecordParserTests
{
    ...
    public void ParseRequestStart()
    {
        ...
        Assert.Equal("InvalidTable | take 10 | where Col1=7", result.QueryText.ToString());
    }

...
public abstract class OtlpProtobufMetricExporterTests
{
    ...
    [Theory]
    [InlineData("longGauge", 123L, null, true, true)]
    [InlineData("longGauge", 123L, null, true, false)]
    [InlineData("longGauge", 123L, null, false, true)]
    [InlineData("longGauge", 123L, null, false, false)]
    [InlineData("doubleGauge", null, 123.45, true, true)]
    [InlineData("doubleGauge", null, 123.45, true, false)]
    [InlineData("doubleGauge", null, 123.45, false, true)]
    [InlineData("doubleGauge", null, 123.45, false, false)]
    [InlineData("longGauge", -123L, null, true, true)]
    [InlineData("longGauge", -123L, null, true, false)]
    [InlineData("longGauge", -123L, null, false, true)]
    [InlineData("longGauge", -123L, null, false, false)]

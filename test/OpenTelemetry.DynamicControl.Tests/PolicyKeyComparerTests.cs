...
public class PolicyKeyComparerTests
{
    ...
    {
        var smaller = new PolicyKey("aaa", "id");
        var larger = new PolicyKey("bbb", "id");
    ...
    {
        var smaller = new PolicyKey("type", "a-id");
        var larger = new PolicyKey("type", "b-id");
    ...
    {
        // Ordinal: 'B' (66) < 'a' (97)
        var upper = new PolicyKey("type", "B");
        var lower = new PolicyKey("type", "a");
    ...
    {
        var real = new PolicyKey("type", "id");
    ...
    {
        var key = new PolicyKey("trace-sampling", "policy-1");
    ...
    {
        var x = new PolicyKey("trace-sampling", "policy-1");
        var y = new PolicyKey("trace-sampling", "policy-1");

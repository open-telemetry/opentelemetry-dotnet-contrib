// <copyright file="SystemRuntimeBuilderTests.cs" company="OpenTelemetry Authors">
...
{
    public class SystemRuntimeBuilderTests
    {
        [Fact]
        public void WithAll_Adds_All_Known_Counter()
        {
            // retrieve all interface methods
            var methodCounts = typeof(ISystemRuntimeBuilder).GetMethods().Length;

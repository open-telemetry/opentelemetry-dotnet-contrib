...
namespace OpenTelemetry.Contrib.Instrumentation.EventCounters.Tests
{
    public class EventCountersOptionsTests
    {
        ...
        public void Can_Be_Read_From_Configuration()
        {
            ...
            Assert.Equal(InstrumentationType.ObservableGaugeDouble, options.Sources[0].EventCounters[0].Type);
            ...
            Assert.Equal(InstrumentationType.ObservableCounter, options.Sources[1].EventCounters[0].Type);
